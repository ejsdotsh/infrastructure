...
// NewDODroplet creates a new DODroplet component from a loader.Machine.
func NewDODroplet(ctx *pulumi.Context, name string, machine loader.Machine, opts ...pulumi.ResourceOption) (*DODroplet, error) {
	component := &DODroplet{}
	...
	d, err := digitalocean.NewDroplet(ctx, fmt.Sprintf("do-droplet-%s", machine.Name), &digitalocean.DropletArgs{
		Image:  pulumi.String(machine.Image),
		Region: pulumi.String(machine.Region),
		Size:   pulumi.String(machine.Size),
		Ipv6:   pulumi.Bool(machine.IPv6),
		Tags:   tags,
