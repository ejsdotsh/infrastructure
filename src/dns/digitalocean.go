...
// NewDigitalOceanDNS creates a new DigitalOceanDNS component from a loader.Domain.
func NewDigitalOceanDNS(ctx *pulumi.Context, name string, domain loader.Domain, opts ...pulumi.ResourceOption) (*DigitalOceanDNS, error) {
	...
	d, err := digitalocean.NewDomain(ctx, fmt.Sprintf("do-domain-%s", domainSlug), &digitalocean.DomainArgs{
		Name: pulumi.String(domain.DomainName),
